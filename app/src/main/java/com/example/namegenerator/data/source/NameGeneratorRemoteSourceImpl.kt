package com.example.namegenerator.data.source
...
class NameGeneratorRemoteSourceImpl @Inject constructor(): NameGeneratorRemoteSource {
    ...
    private val names = Gson().fromJson(json, Names::class.java)

    override suspend fun fetchNames(): List<NameInfo> = names.asDomainModel()

    override fun getNames(): List<NameInfo> = names.asDomainModel()
}